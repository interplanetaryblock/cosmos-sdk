...
const (
	appName = "MulticoinApp"
)

// MulticoinApp implements an extended ABCI application. It contains a BaseApp,
// a codec for serialization, KVStore keys for multistore state management, and
// various mappers and keepers to manage getting, setting, and serializing the
// integral app types.
type MulticoinApp struct {
	*bam.BaseApp
	cdc *wire.Codec
...
func NewMulticoinApp(logger log.Logger, db dbm.DB, baseAppOptions ...func(*bam.BaseApp)) *MulticoinApp {
	// create and register app-level codec for TXs and accounts
	cdc := MakeCodec()

	// create your application type
	var app = &MulticoinApp{
		cdc:        cdc,
...
// by the application.
func (app *MulticoinApp) BeginBlocker(_ sdk.Context, _ abci.RequestBeginBlock) abci.ResponseBeginBlock {
...
func (app *MulticoinApp) initChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
